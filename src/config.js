  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify skill self-assessment with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-fields",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify evidence fields with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "availability-map",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify availability map with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify pod matching view with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
